...
arcpy.ManageTileCache_management(OUTPUT_DIR, "RECREATE_ALL_TILES", NOME_TILE_CACHE, PROJETO_MAPA_BASE, "IMPORT_SCHEME", XML_SCHEME, BASEMAP_SCALES, "", "", MIN_SCALE, MAX_SCALE)
